...
//                .thenReturn(new ResponseEntity<Object>(HttpStatusCode.valueOf(200)));
//
//        ResponseEntity<Object> resp = bookingClient.bookItem(1L,bookingRequestDto);
...
//        when(bookingClient.findBooking(1L, 2L))
//                .thenReturn(bookingDto);
//
...
//        when(bookingClient.findBookings(1L, State.ALL))
...
//        when(bookingClient.findOwnerBookings(1L, State.ALL))
//                .thenReturn(List.of(bookingDto));
//
