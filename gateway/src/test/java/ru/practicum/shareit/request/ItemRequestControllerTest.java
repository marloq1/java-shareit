...
class ItemRequestControllerTest {
    ...
    void testSaveNewRequest() throws Exception {
        when(itemRequestClient.createItemRequest(2L, itemRequestDto))
    ...
    void testGetRequests() throws Exception {
        when(itemRequestClient.getItemRequests(2L))
    ...
    void testGetAllRequests() throws Exception {
        when(itemRequestClient.getAllItemRequests(2L))
                .thenReturn(ResponseEntity.ok(List.of(itemRequestDto)));
    ...
    void testGetRequest() throws Exception {
        when(itemRequestClient.getItemRequest(2L))
                .thenReturn(ResponseEntity.ok(itemRequestDto));
